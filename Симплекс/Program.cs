...
namespace Симплекс
{
    public class Simplex
    {
        ...
        public Simplex(double[,] source)
        {
            ...
            basis = new List<int>();
            for (int i = 0; i < m; i++) // Добавление фиктивных переменных
            {
                ...
                //Постановка коэффициента 1 перед базисной переменной в строке
        ...
        public double[,] Calculate(double[] result)
        {
            ...
            //Заполнение массива найденными X
        ...
        private int findMainRow(int mainCol)//Поиск разрещающей строки
        {
            int mainRow = 0;
            for (int i = 0; i < m - 1; i++)
        ...
        public void simplexBol()
        {
            ...
            try
            {
                using (StreamReader sr = new StreamReader(@"Ввод.csv"))
                {
                    ...
                    // Перестановка первого и последнего столбца
                    for (int i = 0; i < raz1; i++)
                    {
                ...
                //Объявление массив размерностью в два раза больше, чем введенный массив для фиктивных переменных
